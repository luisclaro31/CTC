...
$tituloPagina = "Gestión Municipios";
$soloLectura = "";
...
if(isset($estadoAdicionar) && $estadoAdicionar == true)  
    echo '<div id="dialogo" align="center" class="ventana" title="Informacion">          
        Se adicionó el registro de municipio satisfactoriamente.        
        </div>';
...
<div id='divTituloPrincipal'>  
    ...
    <div id="tabAdicionar">        
        <div id="divConvenio" class="clearfix">            
            <ul id="sidemenu">                
                <li>                    
                    <a href="#informacion-content" class="open"><i class="icon-home icon-large"></i>Información Municipio</a>                
                </li>            
            </ul>            
            <div id="content">                
                <!--Tab Datos Basicos-->                
