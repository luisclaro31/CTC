...
{
  echo form_open('controladorFederacionSindicato/AdicionarFederacionSindicato');
  echo "<script src='/js/federacionSindicato.js'></script>";
}
else
{
  echo form_open('controladorFederacionSindicato/ModificarFederacionSindicato');
  echo "<script src='/js/federacionSindicatoModificar.js'></script>";
}
...
<div id="tabs" class="divTabs">
  ...
  <div id="tabConsultar" align="center">
      <table cellpadding="5" align="center" cellspacing="3" class="td">
          <tr class="trTitulo">
              <td class='td' <?php if($usuario['perfil'] == "Lector Federacion" || $usuario['perfil'] == "Editor Federacion")  echo "id='tdLector'"; else echo "id='tdAdministrador'" ?>></td>
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "RUT Federación"; else echo '<a style="color: #fff;" href="/index.php/controladorFederacionSindicato/index/52">RUT Federación &dArr;</a>' ?></td>            
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "Nombre Federación"; else echo '<a style="color: #fff;" href="/index.php/controladorFederacionSindicato/index/53">Nombre Federación &dArr;</a>' ?></td>
              <td class='td'>Sigla Federación</td>
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "Estado Federación"; else echo '<a style="color: #fff;" href="/index.php/controladorFederacionSindicato/index/56">Estado Federación &dArr;</a>' ?></td>              
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "RUT Sindicato"; else echo '<a style="color: #fff;" href="/index.php/controladorFederacionSindicato/index/1">RUT Sindicato &dArr;</a>' ?></td>            
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "Nombre Sindicato"; else echo '<a style="color: #fff;" href="/index.php/controladorFederacionSindicato/index/23">Nombre Sindicato &dArr;</a>' ?></td>
              <td class='td'>Sigla Sindicato</td>              
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "Estado Sindicato"; else echo '<a style="color: #fff;" href="/index.php/controladorFederacionSindicato/index/10">Estado Sindicato &dArr;</a>' ?></td>
          </tr>
              <?php
              /*
              ...
              if($tituloTab != 'Consulta')
              {
                  if(!isset($consultar))
                  {
                    foreach($registros as $registro)
                    {
                        ...
                        if($usuario['perfil'] == "Administracion" || $usuario['perfil'] == "Editor Federacion" || $usuario['perfil'] == "Lector Federacion")
                        ...
                        else if ($usuario['perfil'] == " ")
                        {
                            echo '<div class="divImgEditar">
                                      <a href="/index.php/controladorFederacionSindicato/ConsultarFederacionSindicato/'.$registro['rut'].'" title="Modificar">
                        ...
                        else if ($usuario['perfil'] == " ")
                        {
                            echo '<div class="divImgEditar">
                                  ...
                                  <div class="divImgEliminar">
                                      <a href="javascript:;" onclick="Confirmar(\'/index.php/controladorFederacionSindicato/EliminarFederacionSindicato/'.$registro['rut'].'\'); return false;"  title="Eliminar">
                                          <img src="/images/eliminar.png" width="20" height="20" alt="Eliminar"/>
                                      </a>
                                  <div>';
                        }                                                    
                        echo "<td class='td'>".$registro['rut_federacion']."</td>";
                        ...
                        echo "<td class='td'>".utf8_decode($registro['estado_sindicato_descripcion'])."</td>
                            </tr>";
      ...
      <div id="divExportarFormatos">
          <div id="divExportarExcel">
              <a href="/index.php/controladorFederacionSindicato/GenerarExcel" target="_blank" title="Exportar a formato Excel">
          ...
          <div id="divExportarPdf">
              <a href="/index.php/controladorFederacionSindicato/GenerarPdf" target="_blank" title="Exportar a formato PDF">
