...
{
  echo form_open('controladorEmpresa/AdicionarEmpresa');
  echo "<script src='/js/empresaAdicionar.js'></script>";
}
else
{
  echo form_open('controladorEmpresa/ModificarEmpresa');
  echo "<script src='/js/empresaModificar.js'></script>";
}
...
if(isset($estadoEliminar) && $estadoEliminar == true)
  echo '<div id="dialogo" align="center" class="ventana" title="Informacion">
          Se elimino satisfactoriamente el registro de empresa.
        </div>';
else if(isset($estadoEliminar) && $estadoEliminar == false)
  echo '<div id="dialogo" align="center" class="ventana" title="Informacion">
          Ocurrio un problema al eliminar el registro de empresa.
        </div>';
/*
...
if(isset($consultar) && $consultar == "1")
  echo "<script src='/js/empresa.js'></script>";

if(/*count($registros) > 0 && */$usuario['perfil'] == 'Lector Sindicato')
  ...
  <div id="tabConsultar" align="center">
      <table cellpadding="5" align="center" cellspacing="3" class="td">
          <tr class="trTitulo">
              ...
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "RUT"; else echo '<a style="color: #fff;" href="/index.php/controladorEmpresa/index/1">RUT &dArr;</a>' ?></td>            
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "Nombre Empresa"; else echo '<a style="color: #fff;" href="/index.php/controladorEmpresa/index/8">Nombre Empresa &dArr;</a>' ?></td>
              <td class='td'>Sigla</td>
              <td class='tdAmpliadoConsulta'>Página web</td>
              <td class='tdAmpliadoConsulta'><?php if($usuario['perfil'] != "Administracion") echo "Departamento"; else echo '<a style="color: #fff;" href="/index.php/controladorEmpresa/index/18">Departamento &dArr;</a>' ?></td>
              <td class='td'><?php if($usuario['perfil'] != "Administracion") echo "Municipio"; else echo '<a style="color: #fff;" href="/index.php/controladorEmpresa/index/17">Municipio &dArr;</a>' ?></td>
                    ...
                    foreach($registros as $registro)
                    {
                        ...
                        if($usuario['perfil'] == "Lector Sindicato")
                            echo '<div class="floatLeft">
                                      <a href="/index.php/controladorEmpresa/ConsultarEmpresa/'.$registro['rut'].'/1" title="Consultar">
                        ...
                        else if ($usuario['perfil'] == "Editor Sindicato")
                        {
                            echo '<div class="divImgEditar">
                                      <a href="/index.php/controladorEmpresa/ConsultarEmpresa/'.$registro['rut'].'" title="Modificar">
                        ...
                        else 
                        {
                            echo '<div class="divImgEditar">
                                  ...
                                  <div class="divImgEliminar">
                                      <a href="javascript:;" onclick="Confirmar(\'/index.php/controladorEmpresa/EliminarEmpresa/'.$registro['rut'].'\'); return false;"  title="Eliminar">
                        ...
                        echo "<td class='td'>".utf8_decode($registro['sigla'])."</td>";
                        echo "<td class='td'>".utf8_decode($registro['pagina_web'])."</td>";
