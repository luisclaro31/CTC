...
class controladorDirectivo extends CI_Controller
{
   ...
   {  
       ...
       $this->load->view('vistaDirectivo', $parametros);
   }
   ...
   public function GenerarExcel()
   {
        ...
        */
        ...
        if($this->session->userdata('perfil') == 'Administracion')
           ...
           $registrosConsultaDirectivo = $this->procedimientos_model->GetProcedure("directivo_sindicato_x_federacion","'".$this->session->userdata('registroFederacion')."'");                
        else
            $registrosConsultaDirectivo = $this->procedimientos_model->GetProcedure("sindicato_seleccionar_por_directivo","'".$this->session->userdata('registroSindical')."'");  
        $i = 2;
   ...
   public function GenerarPdf()
   {
        ...
        if($this->session->userdata('perfil') == 'Administracion')
           $registrosConsultaDirectivo = $this->procedimientos_model->GetProcedure("directivo_sindicato_seleccionar","");
        else if($this->session->userdata('perfil') == 'Editor Federacion')
           $registrosConsultaDirectivo = $this->procedimientos_model->GetProcedure("directivo_sindicato_x_federacion","'".$this->session->userdata('registroFederacion')."'" || $this->session->userdata('perfil') == 'Lector Federacion');        
        else           
           $registrosConsultaDirectivo = $this->procedimientos_model->GetProcedure("sindicato_seleccionar_por_directivo","'".$this->session->userdata('registroSindical')."'");  
   ...
   {              
       ...
       if($this->session->userdata('perfil') == 'Administracion')
           ...
           $sindicatoDirectivo = $this->procedimientos_model->GetProcedure("sindicato_directivo_rut","'".$this->session->userdata('registroSindical')."'");              
