...
class controladorDirectivoFederacionSin extends CI_Controller
{
   ...
   {  
       ...
       $this->load->view('vistaDirectivoFederacionSin', $parametros);
   }
   ...
   public function GenerarExcel()
   {
        ...
        */
        ...
        if($this->session->userdata('perfil') == 'Administracion')
            ...
            $registrosConsultaDirectivo = $this->procedimientos_model->GetProcedure("directivo_federacion_x_perfil","'".$this->session->userdata('registroSindical')."'");        
