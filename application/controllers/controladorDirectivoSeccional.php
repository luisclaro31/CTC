...
class controladorDirectivoSeccional extends CI_Controller
{
   ...
   {  
       ...
       $this->load->view('vistaDirectivoSeccional', $parametros);
   }
   ...
   public function GenerarExcel()
   {
        ...
        */
        ...
        if($this->session->userdata('perfil') == 'Administracion')
            ...
            $registrosConsultaDirectivo = $this->procedimientos_model->GetProcedure("directivo_seccional_seleccionar_principal_x_perfil","'".$this->session->userdata('registroSeccional')."'");
   ...
   {       
       ...
       if($this->session->userdata('perfil') == 'Administracion')
           ...
           $seccionalDirectivo = $this->procedimientos_model->GetProcedure("seleccionar_directivo_seccional_seleccionar_x_pefil","'".$this->session->userdata('registroSeccional')."'");                        
