...
//calcular el maximo de caracteres en un campo
...
function borrar(formObj) { 

    if(!confirm("Desea borrar el item seleccionado?"))
        {return false;} 
    else {
        window.location(formObj);
        return false;        
    }
